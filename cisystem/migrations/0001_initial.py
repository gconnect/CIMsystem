    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registered_username', models.CharField(blank=True, default=None, max_length=200, null=True, unique=True)),
                ('registered_password', models.CharField(blank=True, default=None, max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('is_eligible', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cisystem.Birth')),
            ],
        ),
        migrations.CreateModel(
            name='Death',
